  ...
  return (
    <main className="article-page">
      ...
      <header className="article-hero">
        <a href="/blog" className="article-back"><span aria-hidden="true"><LuArrowLeft /></span> All articles</a>
        <p>Architecture · September 19, 2026 · 7 min read</p>
        <h1>Elevators as an Essential Part of Modern Architecture</h1>
        <span>How thoughtful vertical mobility can shape arrival, movement and the character of an entire building.</span>
      </header>

      <figure className="article-cover"><img src="/images/elevator-lobby-luxe.png" alt="Bronze elevators integrated into a refined residential lobby" /></figure>

      <article className="article-content">
        <aside><span>Written by</span><strong>BG Tatva Editorial</strong><a href="mailto:info@bgtatva.com">Share this article <span aria-hidden="true"><LuArrowRight /></span></a></aside>
        <div className="article-body">
          ...
          <figure><img src="/images/social-elevator-3.png" alt="Glass panoramic elevator at the centre of a double-height residence" loading="lazy" /><figcaption>A panoramic elevator can become a transparent architectural centrepiece.</figcaption></figure>
          ...
          <ul><li>Use warm, indirect light for comfort and material depth.</li><li>Keep controls clearly illuminated and easy to understand.</li><li>Coordinate cabin and lobby colour temperatures.</li><li>Use reflective surfaces carefully to avoid visual noise.</li></ul>

          <figure><img src="/images/social-elevator-4.png" alt="Open bronze elevator integrated beside a luxury lounge" loading="lazy" /><figcaption>Cabin light and surrounding architecture should read as one experience.</figcaption></figure>
          ...
          <div className="article-conclusion"><p>Planning an elevator-led project?</p><h2>Design the journey from the beginning.</h2><a href="/contact">Talk to our team <span aria-hidden="true"><LuArrowRight /></span></a></div>
        </div>
      </article>
