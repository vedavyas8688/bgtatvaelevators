...
export default function AboutHeroSection() {
  return (
    <section className="grid min-h-screen bg-[#f5f3ec] pt-[96px] text-[#172e3b] lg:h-[100svh] lg:min-h-[700px] lg:grid-cols-[.88fr_1.12fr] lg:overflow-hidden">
      <div className="flex min-h-0 flex-col justify-between px-[clamp(28px,7vw,110px)] py-[clamp(34px,5vh,68px)]">
        <p className="m-0 text-[11px] font-semibold uppercase tracking-[.22em] text-[#9c653f]">BG Tatva · Bengaluru</p>
        <div className="my-[clamp(24px,4vh,48px)]">
          <h1 className="m-0 text-[clamp(56px,6.4vw,98px)] font-medium leading-[.86] tracking-[-.06em]">Made for<br />the way<br /><em className="font-light text-[#9c653f]">you move.</em></h1>
          <p className="mb-0 mt-7 max-w-[560px] text-[16px] leading-[1.68] text-[#59666a]">Elevators considered as part of the architecture, supported by a Bengaluru team that stays close from first plan to everyday use.</p>
        </div>
